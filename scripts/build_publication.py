...
def main():
    ...
    semantic={'@context':'https://chris-page-gov.github.io/okf-explorer/profile/bundle-wiki/v1/context.jsonld','@id':'https://chris-page-gov.github.io/okf-ai-infrastructure/','@type':'okf:Bundle','title':'AI Infrastructure OKF Wiki','description':'Agent-ready infrastructure, federated AI, standards, frameworks, research and UK public-sector implications.','version':'0.4.0','status':'preview','profile':{'@id':'https://chris-page-gov.github.io/okf-explorer/profile/bundle-wiki/v1/'},'descriptor':{'@id':'https://chris-page-gov.github.io/okf-ai-infrastructure/okf-bundle.json'},'publisher':{'@id':'https://github.com/chris-page-gov'},'license':{'@id':'https://creativecommons.org/publicdomain/zero/1.0/'}}
